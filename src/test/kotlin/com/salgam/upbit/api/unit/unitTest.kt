...
import com.salgam.upbit.api.unit.dummy.DummyAction
...
class unitTest {
    ...
    fun testSum() {
        ...
        val listener = UpbitWebSocketListener(DummyAction())
        ...
        val webSocket = listener.makeWebsocket(accessKey, secretKey)
